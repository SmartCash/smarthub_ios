...
//}
//
//extension MyWalletsAPI: ResponseObjectSerializable, ResponseCollectionSerializable {
//  init?(json: JSON) {
//    guard
...
//      else { return nil }
//    
//    let wallets = Wallet.collection(json: json["data"])
//    
////    self.savings = (wallets.filter { $0.displayName == "Savings Account" }).first!
////    self.checking = (wallets.filter { $0.displayName == "Checking Account" }).first!
//    self.status = status
//    self.isValid = isValid
//    self.wallets = wallets
//    
////    MyWallets.shared.myWallets = self
//    MyWallets.shared.allWallets = wallets
